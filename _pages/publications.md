...
I maintain a set of freely available [Google Earth Engine codes](https://github.com/tasmi/earthengine_code_snippets) written in Python for data pre-processing and analysis tasks. I also maintain a set of codes and instructions for building low-cost environmental sensors [here](https://github.com/UP-RS-ESP/LowCostSensors). For further research profiles, see my: [Google Scholar](https://scholar.google.com/citations?user=RlDWFDsAAAAJ), 
...
| **2026**
30 | S Ma, S Zhou, D Ellison, A Staal, **T Smith**, C Smith, and A J Teuling. "Targeted tropical forest restoration can offset deforestation-induced water flux losses." Nature Climate Change (2026). [https://doi.org/10.1038/s41558-026-02709-7](https://doi.org/10.1038/s41558-026-02709-7)
...
15 | **T Smith**, R.-M. Zotta, C. A. Boulton, T. M. Lenton, W. Dorigo, and N. Boers. "Reliability of Resilience Estimation based on Multi-Instrument Time Series", Earth System Dynamics, 14, 173–183, (2023). [https://doi.org/10.5194/esd-14-173-2023](https://doi.org/10.5194/esd-14-173-2023)
...
| **2026-**
14 | **T Smith** (2026). Estimating the Resilience of Non-Stationary Systems. Zenodo. [https://doi.org/10.5281/zenodo.19731233](https://doi.org/10.5281/zenodo.19731233)
